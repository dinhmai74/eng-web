...
export default class WallStreetEnglish extends React.PureComponent<IProps, any> {
  render() {
    return (
      <Section bgColor="light">
        <Container>
          ...
          <Flex>
            <Flex alignItems="center" justifyContent="flex-end" width={1 / 2} bg="#003C78">
            ...
            <Box width={1 / 2} bg="white">
              <img style={{ height: "100%", maxWidth: "100%" }} src={images.img2} />
            </Box>
          </Flex>
